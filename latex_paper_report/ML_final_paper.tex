...
We are aware that the definition of stress is subjective and the use of body sensors may provide more convincing result. However, for project scope, our work focuses on self-report of stress state as with  existing literature\cite{epp2011identifying}, \cite{wang2014studentlife}. 
\section{Methodology}
